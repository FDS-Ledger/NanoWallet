function ItalianProvider($translateProvider) {
    ...
    $translateProvider.translations('it', {
        ...
        OPTIN_TAC_INFO_1:'Process Opt In è una funzionalità lanciata da NEM Group Limited per aiutare gli utenti NIS1 a migrare i propri saldi sulla nuova rete Symbol. Questo processo contiene alcune regole che devono essere rigorosamente seguite da tutti i partecipanti che lo eseguono.',
        OPTIN_TAC_INFO_2: 'NEM Group Limited non sarà ritenuta responsabile per eventuali incidenti al di fuori delle condizioni specificate di seguito.',
