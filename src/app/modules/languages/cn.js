function ChineseProvider($translateProvider) {
    ...
    $translateProvider.translations('cn', {
        ...
        PORTAL_CATAPULTOPTIN_TEXT: '用此模块在Symbol网络上接收 XYM。您还可选择注册您的命名空间和给多签名帐户进行选择加入。您的马赛克余额、Apostille数据、收获合约的委派以及所有其他 DAP 内容不会移送。请进一步阅读， ',
        PORTAL_CATAPULTOPTIN_TEXT_LINK: '点击此处',
        PORTAL_CATAPULTOPTIN_MULTISIG_TEXT: '您的多签名的选择加入请求必须与共同签名者帐户一起发出',
        PORTAL_CATAPULTOPTIN_BTN_1: '通过Symbol选择加入认领XYM 和命名空间',
        ...
        CATAPULTOPTIN_ACCOUNT_UNLOCK: '输入您的Symbol助记词',
