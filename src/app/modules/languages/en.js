function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        OPTIN_TAC_INFO_1:'The Opt-in process is a feature launched by NEM Group Limited with the aim of helping NIS1 users migrate their balances to their new Symbol network. It is a process defined under certain parameters that all users who adhere to it have to comply with.',
        OPTIN_TAC_INFO_2:'NEM Group Limited will not be liable for any incidents outside of the terms and conditions specified below.',
