function SpanishProvider($translateProvider) {
    ...
    $translateProvider.translations('es', {
        ...
        OPTIN_TAC_INFO_1:'El proceso de Opt-in es una funcionalidad lanzada por NEM Group Limited con el ánimo de ayudar a los usuarios de NEM NIS1 a migrar sus balances a la nueva red Symbol. Se trata de un proceso definido bajo ciertos parámetros sobre los que los usuarios tienen que adherirse para completarlo.',
        OPTIN_TAC_INFO_2:'NEM Group Limited no se hace responsable de ningún inicidente que pueda suceder fuera de los términos y condiciones especificados a continuación.',
