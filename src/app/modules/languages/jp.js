function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('jp', {
      ...
      PORTAL_CATAPULTOPTIN_TEXT: 'このモジュールを使用して、Symbolのネットワーク上でXYMを受領してください。また、オプトインすることにより、ネームスペースの登録やマルチシグアカウントのオプトインも可能になります。ただし、モザイク残高、アポスティーユ（Apostille、公証）のデータ、委任ハーベストのコントラクト、その他すべてのDAP（DApp APIプラットフォーム）コンテンツは一切繰越されません。さらに詳しくは、',
      ...
      PORTAL_CATAPULTOPTIN_BTN_1: 'SymbolにオプトインしてXYMとネームスペースを請求する',
      ...
      CATAPULTOPTIN_ACCOUNT_UNLOCK: 'Symbol用のニーモニックを入力してください',
      ...
      CATAPULTOPTIN_REVIEW_NORMAL_RESULT: 'Symbolアカウントのオプトイン情報を再確認する',
      ...
      OPTIN_TAC_READ_ACCEPT: '私は、(xxx) を読んだうえで承諾します。',
