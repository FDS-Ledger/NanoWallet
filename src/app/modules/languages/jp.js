function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('jp', {
      ...
      OPTIN_TAC_TEXT:'利用規約',
      OPTIN_TAC_INFO_1:'オプトインのプロセスは、NIS1ユーザーの残高を新たなSymbolネットワークに移行するための支援を目的として、NEM Group Limitedがローンチした機能です。これは一定のパラメータによって定義されるプロセスで、それを実行する全ユーザーが遵守しなければなりません。',
      OPTIN_TAC_INFO_2:'NEM Group Limitedは、以下に明記する利用規約の範囲外で発生した一切の事故に対する法的責任を負いません。',
